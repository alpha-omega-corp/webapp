...
import {Secret} from "@assets/models/config";
import ButtonComponent from "@Components/ButtonComponent.vue";
import {TrashIcon, PlusCircleIcon, ArrowPathRoundedSquareIcon, EyeDropperIcon} from "@heroicons/vue/20/solid";
...
<template>
  <div class="flex gap-x-2">
    ...
    <ButtonComponent
      ...
      <ArrowPathRoundedSquareIcon class="-ml-0.5 h-5 w-5" aria-hidden="true"/>
    </ButtonComponent>
        ...
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tr v-for="secret in secrets" :key="secret.name">
              <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">{{ secret.name }}</td>
              ...
              <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                ...
                <div class="flex gap-x-2">
                  ...
                  <ButtonComponent
                    ...
                    <EyeDropperIcon class="-ml-0.5 h-5 w-5" aria-hidden="true"/>
                  </ButtonComponent>
                </div>
              </td>
            </tr>
